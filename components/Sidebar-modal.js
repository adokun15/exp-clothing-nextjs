...
export default function SidebarModal({ offmodal }) {
  ...
  return (
    <>
      ...
      ></div>
      <div className="fixed text-center space-y-[4%] py-[5%] text-2xl bg-white z-[20] top-0 w-[40%] h-full ">
        {isAuthenticated ? (
          <Authencaticated />
        ) : (
      ...
      <button
        onClick={offmodal}
        className="absolute left-[45%] text-3xl font-sans text-slate-200  top-10  z-[30]"
      >
        x
      </button>
    </>
